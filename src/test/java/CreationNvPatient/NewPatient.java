...
public class NewPatient extends Base {
	...
	public void testCreatePatient() throws InterruptedException {
		...
		WebElement day = driver
				.findElement(By.xpath("//div[@class='btn-light ng-star-inserted'][normalize-space()='2']"));
		day.click();
		...
		/*
		 * WebDriverWait wait = new WebDriverWait(driver, 10); WebElement getconfirm =
		 * wait .until(ExpectedConditions.elementToBeClickable(pt.getConfirm()));
		 * getconfirm.click();
		 */
